...
def _flatten(j: Dict, src_path: str) -> Dict:
    ...
    row = {
        ...
        "eval_layout": protocol.get("eval_layout", ""),
        "layout_split": protocol.get("layout_split", ""),
        "layout_used_for_training": protocol.get("layout_used_for_training", ""),
        "layout_used_for_validation": protocol.get("layout_used_for_validation", ""),
        "layout_family": protocol.get("layout_family", ""),
        "layout_features": protocol.get("layout_features", ""),
        ...
        "avoid_conflict_y_raw_mean": overall.get("avoid_conflict_y_raw_mean", ""),
        "avoid_conflict_y_eff_mean": overall.get("avoid_conflict_y_eff_mean", ""),
        ...
        "avoid_conflict_cmd_y_mean": overall.get("avoid_conflict_cmd_y_mean", ""),
        "avoid_conflict_cmd_f_y_mean": overall.get("avoid_conflict_cmd_f_y_mean", ""),
        "avoid_conflict_cmd_a_y_mean": overall.get("avoid_conflict_cmd_a_y_mean", ""),
