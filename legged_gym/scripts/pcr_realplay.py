...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max_cmd_x", type=float, default=0.40)
    parser.add_argument("--max_cmd_y", type=float, default=0.80)
    parser.add_argument("--max_cmd_yaw", type=float, default=0.375)
