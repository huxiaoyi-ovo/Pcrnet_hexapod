...
class HexAvoidBasicCfg(HexGroundCfg):
    ...
    class navigation(HexGroundCfg.navigation):
        ...
        reward_cfg["avoid_lat_mag_scale"] = 4.0
        reward_cfg["avoid_lat_over_scale"] = 1.0
        ...
        reward_cfg["avoid_row_lat_scale"] = 24.0
        reward_cfg["avoid_row_gap_scale"] = 96.0
        reward_cfg["avoid_row_push_scale"] = 0.5
        reward_cfg["avoid_row_push_margin"] = 0.25
        reward_cfg["avoid_row_cmdx_scale"] = 20.0
        reward_cfg["avoid_row_cmdx_err_gain"] = 1.0
        reward_cfg["avoid_row_cmdx_min"] = 0.08
        reward_cfg["avoid_row_cmdx_max"] = 0.60
...
class HexPCRLineAvoidBasicCfg(HexAvoidBasicCfg):
    ...
    class navigation(HexAvoidBasicCfg.navigation):
        ...
        reward_cfg["follow_outside_penalty"] = 0.0
        reward_cfg["collision_penalty"] = -50.0
        reward_cfg["terminal_fail_penalty"] = -10.0
        reward_cfg["heading_scale"] = 0.0
        reward_cfg["heading_offset_rad"] = 0.0
        reward_cfg["heading_use_difficulty_gate"] = False
        reward_cfg["heading_min_weight"] = 0.2
        reward_cfg["heading_gate_use"] = False
        reward_cfg["heading_gate_min_speed"] = 0.05
        reward_cfg["heading_gate_min_approach"] = 0.0
        reward_cfg["passable_align_scale"] = 0.0
        reward_cfg["passable_occ_ratio_low"] = 0.05
        reward_cfg["passable_occ_ratio_high"] = 0.4
        reward_cfg["passable_sector_deg"] = 60.0
        ...
        reward_cfg["risk_barrier_tau"] = 0.10
        reward_cfg["time_penalty"] = -0.01
        reward_cfg["stability_scale"] = 0.1
        reward_cfg["pitch_threshold"] = 0.3
        reward_cfg["roll_threshold"] = 0.3
        reward_cfg["velocity_scale"] = 0.0
        reward_cfg["backward_scale"] = 0.0
        reward_cfg["body_backward_scale"] = 0.0
        reward_cfg["turn_penalty_scale"] = 0.0
        ...
        reward_cfg["avoid_side_probe_x"] = 0.45
        reward_cfg["avoid_side_clear_margin"] = 0.15
        reward_cfg["avoid_row_lat_scale"] = 4.0
        reward_cfg["avoid_row_gap_scale"] = 10.0
        reward_cfg["avoid_row_push_scale"] = 0.2
        reward_cfg["avoid_row_push_margin"] = 0.25
        reward_cfg["avoid_row_cmdx_scale"] = 3.0
        reward_cfg["avoid_row_cmdx_err_gain"] = 1.0
        reward_cfg["avoid_row_cmdx_min"] = 0.08
        reward_cfg["avoid_row_cmdx_max"] = 0.60
        reward_cfg["avoid_row_group_tol"] = 0.25
        ...
        reward_cfg["avoid_row_gate_on"] = 1.0
        reward_cfg["avoid_row_gate_full"] = 0.4
        reward_cfg["avoid_smooth_scale"] = 1.5
        reward_cfg["avoid_smooth_switch_threshold"] = 0.05
        reward_cfg["avoid_smooth_switch_unit"] = 0.008
        reward_cfg["avoid_early_next_gap_threshold"] = 0.20
        reward_cfg["avoid_early_next_gap_scale"] = 0.5
        reward_cfg["avoid_heading_keep_scale"] = 0.0
        reward_cfg["avoid_heading_event_penalty"] = 0.4
